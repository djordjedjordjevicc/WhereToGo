...
const  UgostiteljskiObjekatPassword=()=> {
   ...
   const [object, setObject] = useState({})
      ...
      const changePassword= useCallback(async(e)=>{
               ...
               try{
              const url=`https://localhost:7193/ugostiteljskiObjekat/PromeniPassword/${object.iD_Korisnik}/${pwd}/${newPwd}`;
   ...
   <>
       ...
       <section style={{backgroundColor:'#2f2f33',marginTop:'50px'}}>
         ...
         <p style={{marginLeft:'150px',marginTop:'100px'}}>
           <Link className='fontLog' style={{color:'#f0f0f7'}} to="/UgostiteljskiObjekatHome">Home</Link>
         </p>
       </section>
     ) : (
       <>
...
export default UgostiteljskiObjekatPassword;